        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <div class="card card-success">
                  <div class="card-header">       
                    <div class="icheck-default d-inline" >
                      <input type="checkbox" value="1" id="tabname" class="selectall">
                  ...
                  <div class="card-body">
                      ...
                      <div class="col-sm-12">
                        <div class="form-group clearfix">
                          <div class="icheck-success d-inline">
                            <input type="checkbox" name="1" id="checkboxPrimary1">
                    ...
                    <div class="row">
                      <div class="col-sm-12">
                        <div class="form-group clearfix">
                          <div class="icheck-success d-inline">
                            <input type="checkbox" name="1" id="checkboxDanger1">
                    ...
                    <div class="row">
                      <div class="col-sm-12">
                        <div class="form-group clearfix">
                          <div class="icheck-success d-inline">
                            <input type="checkbox" name="1" id="checkboxSuccess1">
