...
<body>
	...
	<div class="wrap">
	    <div class="gray">
  	    	<a href="{{route('home')}}" class="ag-3d_button orange">Go Back </a>
  	     </div>
   </div>
	<div class="footer">
	 <p>&copy; {{ date('Y') }} . All Rights Reserved | Design by <a href="http://tcsoftwareonline.com/">TC Software</a></p>
	</div>
</body>
</html>